...
VALUES (1, 'unknown', CURRENT_TIMESTAMP(), 'unknown', CURRENT_TIMESTAMP(), 100, 1000000, '상해치료비');

INSERT INTO COLLATERAL(COLLATERAL_ID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, BASE_AMOUNT, INSURE_AMOUNT, NAME)
VALUES (2, 'unknown', CURRENT_TIMESTAMP(), 'unknown', CURRENT_TIMESTAMP(), 100, 500000, '항공기 지연도착시 보상금');

INSERT INTO COLLATERAL(COLLATERAL_ID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, BASE_AMOUNT, INSURE_AMOUNT, NAME)
VALUES (3, 'unknown', CURRENT_TIMESTAMP(), 'unknown', CURRENT_TIMESTAMP(), 38, 750000, '부분손실');

INSERT INTO COLLATERAL(COLLATERAL_ID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, BASE_AMOUNT, INSURE_AMOUNT, NAME)
VALUES (4, 'unknown', CURRENT_TIMESTAMP(), 'unknown', CURRENT_TIMESTAMP(), 40, 1570000, '전체손실');
...
VALUES (1, 'unknown', CURRENT_TIMESTAMP(), 'unknown', CURRENT_TIMESTAMP(), 3, 1, '여행자 보험', '2023-06-30', '2022-07-01');

INSERT INTO PRODUCT(PRODUCT_ID, CREATED_BY, CREATED_DATE, MODIFIED_BY, MODIFIED_DATE, MAX_CONTRACT_MONTHS, MIN_CONTRACT_MONTHS, NAME, VALIDITY_END_DATE, VALIDITY_START_DATE)
VALUES (2, 'unknown', CURRENT_TIMESTAMP(), 'unknown', CURRENT_TIMESTAMP(), 12, 1, '휴대폰 보험', '2023-06-30', '2022-07-01');
